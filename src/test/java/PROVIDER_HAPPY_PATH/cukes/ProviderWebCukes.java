package PROVIDER_HAPPY_PATH.cukes;
...
import static MMH.pages.HomePage.strSystemName;
...
//clean test -Dapp=PROVIDER_HAPPY_PATH -Dexecution_type=browser -Drunner=ProviderWebCukes -Dbrowser_name=chrome -Denv=PROD "-DargLine=-Dextent.reporter.spark.out=reports/Extent-Report/WebApp-QAResults.html -Dsysteminfo.AppName=Demo-QA"
