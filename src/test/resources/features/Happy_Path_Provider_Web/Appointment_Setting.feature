Feature: Appointment Setting
  ...
  Scenario Template:S2-Provider Enable Rule A verify Patient Book Phone Appointment based on Rule A (Any Location with Any Provider) & (Default Location with Default Provider) & (Default Location with Any Provider)
    ...
    Examples:
      | Any_Location_with_Any_Provider_Appointment_Details      | Location     | Default_Location_with_Default_Provider_Appointment_Details      | Default_Location_with_Any_Provider_Appointment_Details      |
      | &ANY_LOCATION_WITH_ANY_PROVIDER_BOOK_PHONE_APPOINTMENT& | VM03Location | &DEFAULT_LOCATION_WITH_DEFAULT_PROVIDER_BOOK_PHONE_APPOINTMENT& | &DEFAULT_LOCATION_WITH_ANY_PROVIDER_BOOK_PHONE_APPOINTMENT& |
  ...
  Scenario Template:S5-Provider Enable Rule B verify Patient Book Phone Appointment based on Rule B (Default Location with Default Provider) & (Default Location with Any Provider)
    ...
    And As a user I am on HomePage and navigate to Book Appointment Page in Appointments
    When I navigate to Book Appointment select Default Location with Default Provider
    And I enter the phone appointment details "<Default_Location_with_Default_Provider_Appointment_Details>" and Verify without payment
    Then I navigate to Book Appointment select Default Location with Any Provider
    And I enter the phone appointment details "<Default_Location_with_Any_Provider_Appointment_Details>" and Verify without payment

    Examples:
      | Location     | Default_Location_with_Default_Provider_Appointment_Details      | Default_Location_with_Any_Provider_Appointment_Details      |
      | VM03Location | &DEFAULT_LOCATION_WITH_DEFAULT_PROVIDER_BOOK_PHONE_APPOINTMENT& | &DEFAULT_LOCATION_WITH_ANY_PROVIDER_BOOK_PHONE_APPOINTMENT& |
  ...
  Scenario Template:S6-Provider Enable Rule B verify Patient Book Video Appointment based on Rule B (Default Location with Default Provider) & (Default Location with Any Provider)
    ...
    And As a user I am on HomePage and navigate to Book Appointment Page in Appointments
    When I navigate to Book Appointment select Default Location with Default Provider
    And I enter the video appointment details "<Default_Location_with_Default_Provider_Appointment_Details>" and Verify without payment
    Then I navigate to Book Appointment select Default Location with Any Provider
    And I enter the video appointment details "<Default_Location_with_Any_Provider_Appointment_Details>" and Verify without payment

    Examples:
      | Location     | Default_Location_with_Default_Provider_Appointment_Details      | Default_Location_with_Any_Provider_Appointment_Details      |
      | VM03Location | &DEFAULT_LOCATION_WITH_DEFAULT_PROVIDER_BOOK_VIDEO_APPOINTMENT& | &DEFAULT_LOCATION_WITH_ANY_PROVIDER_BOOK_VIDEO_APPOINTMENT& |
